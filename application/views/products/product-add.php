    ...
    <div class="card card-block">
        ...
        <form method="post" id="data_form" class="form-horizontal">
            <div class="grid_3 grid_4">
                <h5><?php echo $this->lang->line('') ?>Agregar nuevo Servicio</h5>
                <hr>
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label"
                           for="product_name"><?php echo $this->lang->line('') ?>Nombre Servicio</label>
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label"
                           for="product_cat"><?php echo $this->lang->line('') ?>Categoria Servicio</label>
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label"
                           for="product_code"><?php echo $this->lang->line('') ?>Codigo Servicio</label>
