        ...
        <div class="content-header row">
            <div class="card card-block">
                ...
                <form method="post" id="data_form" name="soporte">
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">                               
                                ...
                                <div id="customer">
                                    ...
                                    <div class="clientinfo">
                                        DNI: <?php echo $thread_info['documento'] ?>
                                    </div>
                                    <div class="clientinfo">
                                       Cell phone: <?php echo $thread_info['celular'] ?>
                                    </div>
									<div class="clientinfo">
                                        Direction: <?php echo $thread_info['nomenclatura'] ?> <?php echo $thread_info['numero1'] ?><?php echo $thread_info['adicionauno'] ?> N <?php echo $thread_info['numero2'] ?> <?php echo $thread_info['adicional2'] ?> - <?php echo $thread_info['numero3'] ?>
                                    </div>
                                    <hr>                                    
                                </div>
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                        ...
                                        <div class="input-group">
											...
											<input type="hidden" value="<?php echo $thread_info['idt'] ?>" name="customer_id"></input>
                                            	<select name="subject" class="form-control" onchange="cambia()">
													...
													<option value="servicio">Service ticket</option>								
													<option value="reclamo">claim ticket</option>
												</select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
										<label for="invociedate" class="caption">ticket date</label>
								...
								<div class="form-group row">
									<div class="col-sm-4">
										...
										<select name="agendar" id="agendar" class="form-control mb-1">
												...
												<option value="actualizar">Update</option>
											</select>
										</div>
                                        </div>
                                    <div class="col-sm-4">
					...
					<input type="submit" class="btn btn-success sub-btn" value="Update" id="submit-data" data-loading-text="Creating...">
...
<script type="text/javascript">
	...
	<?php }else{ ?>
	var perfil_servicio = new Array ("...","Arreglar tuberia","AgregarTelevision","Migracion","Bajar 15 Mg","Bajar 10 Mg","Bajar 5 Mg","Cambio de equipo","Corte Combo","Corte Internet","Corte Television","Equipo adicional","Instalacion","Punto nuevo","Subir 5 Mg","Subir 10 Mg","Subir 15 Mg","Subir 20 Mg","Subir 70Mb","Suspension Combo","Suspension Internet","Suspension Television","Traslado","Toma Adicional");
	<?php }; ?>
