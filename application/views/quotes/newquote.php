                ...
                <form method="post" id="data_form" name="soporte">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">                               
                                ...
                                <div id="customer">
                                    ...
                                    <div class="clientinfo">
                                        DNI: <?php echo $details['documento'] ?>
                                    </div>
                                    <div class="clientinfo">
                                        Cell phone: <?php echo $details['celular'] ?>
                                    </div>
									<div class="clientinfo">
                                        Direction: <?php echo $details['nomenclatura'] ?> <?php echo $details['numero1'] ?><?php echo $details['adicionauno'] ?> N <?php echo $details['numero2'] ?> <?php echo $details['adicional2'] ?> - <?php echo $details['numero3'] ?>
                                    </div>
                                    <hr>                                    
                                </div>
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12"><h3
                                                class="title"><?php echo $this->lang->line('') ?>Ticket properties</h3>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
										<label for="invocieno" class="caption">ticket type</label>
                                        <div class="input-group">
											...
											<span class="icon-file-text-o" aria-hidden="true"></span></div>
												...
												<!--<option value="servicio">Orden de servicio</option>	-->							
													<option value="reclamo">claim order</option>
												</select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
										<label for="invocieno" class="caption">ticket detail</label>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
										<label for="invociedate" class="caption">order date</label>
									...
									<div class="col-sm-6">
										<label for="invociedate" class="caption">bill month</label>
										<div class="input-group">
										<select name="factura" class="form-control mb-1">
											...
											<code>* Select current month utility bill </code>
										</div>
                                        </div>
                                    </div>
								<div class="form-group row">									
								...
								<div class="form-group row">
									<div class="col-sm-4">
										<label for="invociedate" class="caption">Schedule</label>
										<div class="input-group">
                                    ...
                                    <div class="col-sm-4">
										<label for="invociedate" class="caption">Date to perform</label>
									...
									<div class="col-sm-4">
										<label for="invociedate" class="caption">Hour</label>
							...
							<div class="form-group row">
									<div class="col-sm-12">
										<label for="invociedate" class="caption">Assign Collaborator</label>
										<div class="input-group">
					...
					<div class="form-group row" id="Revision_de_television">
                        <div class="col-sm-12">
                            <label for="toAddInfo" class="caption">tuberia dañada</label>
                            	<select name="problema_tv" class="form-control mb-1">
									<option value="">-</option>
									<option value="Señal Lluviosa">no hay electricidad</option>
									<option value="Televisor desconfigurado">escape de agua</option>
									<option value="Cambio de Tecnologia">escape de gas</option>
									<option value="No hay Television">mantenimiento paredes</option>
								</select>
						</div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <label for="toAddInfo" class="caption">Ticket description</label>
...
<script type="text/javascript">
	...
	<?php }; ?>
	var perfil_reclamo = new Array ("...","Arreglos Generales","Arreglo tuberia","otras");	
