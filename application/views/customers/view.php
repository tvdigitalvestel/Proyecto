                    ...
                    <div class="col-md-8">
                        <div class="card card-block">
                           ...
                           <!-- <div class="row m-t-lg">
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('') ?>Estado:</strong>
                                </div>
                                <div class="col-md-10">
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('') ?>Condados:</strong>
                                </div>
                                <div class="col-md-10">
                            ...
                            <div class="row mt-3">
								...
								<div class="col-md-4" style="margin-top: 5px;">
                                    ...
                                    <a href="#pop_model3" data-toggle="modal" onclick="funcion_status();" data-remote="false" 
                                       class="btn btn-primary btn-lg" style="width: 250px"><i
