    ...
    <div class="card card-block">
        ...
        <div class="grid_3 grid_4">
                        ...
                        <div class="card-block">
                            ...
                            <div class="tab-content px-1 pt-1">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select style="width: 100%;" name="trans_type[]" class="form-control select-box" id="estados" multiple="multiple">
                                                    ...
                                                    <option value='Resuelto'>Resolved</option>
													<option value='Anulada'>canceled</option>
                                                </select>
                                            </div>                              
                                        </div>    
                                </div>
								<div class="tab-pane fade" id="detalle" role="tabpanel" aria-labelledby="detalle-tab" aria-expanded="false">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label"
                                                   for="detalle">ticket detail</label>
                                ...
                                <div class="tab-pane fade" id="thread" role="tabpanel" aria-labelledby="thread-tab" aria-expanded="false">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label"
                                               for="pay_cat">dates</label>

                                        <div class="col-sm-6">
                                            <select name="trans_type" class="form-control" id="fechas" onchange="filtrado_fechas()">
                                                <option value=''>All</option>
                                                <option value='fcreada'>Date Created</option>
                                                <option value='fcierre'>Closing Date</option>
                                            </select>
                                        </div>                              
                                    </div>
                                    <div class="form-group row" id="div_fechas" style="display: none">
                                        <label class="col-sm-2 col-form-label"
                                               for="pay_cat" id="label_fechas">Date Created</label>
			...
			<div class="table-responsive">
				<a href="#" onclick="redirect_to_export()" class="btn btn-success btn-md">export to Excel .XLSX</a>
			...
			<div class="col-md-12">
			 	<div class="col-md-12">
					<h6 class="colspan 1">ASSIGN ORDER</h6>
				</div>
            ...
            <div class="col-xs-2 mb-1">
                    <input type="hidden" id="action-url" value="tickets/update_status">
                        <button type="button" class="btn btn-primary"
                                onclick="asignar_tecnico()">To assign</button>
                </div>
            </div>
			<?php } ?>
			</div>
