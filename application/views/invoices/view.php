                    ...
                    <div class="row">
                        <div class="col-xs-12 mb-1"><label
                            ...
                            <select name="pmethod" class="form-control mb-1" onchange="metodo_de_pago_select()" id="select_metodo_de_pago">
                                ...
                                <option value="Money order"><?php echo $this->lang->line('Money order') ?></option>
                                <option value="Cashier check"><?php echo $this->lang->line('Cashier check') ?></option>
                            ...
                            <!--<div class="col-xs-12 mb-1"><label
                                    for="concept"><?php echo $this->lang->line('Concept') ?></label>
                            <select name="concept" class="form-control mb-1" onchange="metodo_de_pago_select()" id="select_metodo_de_pago2">
                              <option value="Rent"><?php echo $this->lang->line('Rent') ?></option> 
                             <option value="Partial rent"><?php echo $this->lang->line('Partial rent') ?></option>
                             <option value="Deposit"><?php echo $this->lang->line('Deposit') ?></option>
                             <option value="Debt"><?php echo $this->lang->line('Debt') ?></option>
                            </select>-->
