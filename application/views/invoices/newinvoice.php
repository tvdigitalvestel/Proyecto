...
<thead>
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="right" colspan="8"><input type="submit" class="btn btn-success sub-btn" value="<?php echo $this->lang->line('Generate Invoice') ?> " id="submit-data" data-loading-text="Creating...">
            ...
            <form method="post" id="product_action" class="form-horizontal" name="formulario1">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <h6><label class="col-sm-2 col-form-label"
                               for="customergroup"><?php echo $this->lang->line('') ?>Edificio</label></h6>
