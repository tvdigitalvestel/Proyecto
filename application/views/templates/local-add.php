        ...
        <form method="post" id="data_form" class="form-horizontal">
            <div class="grid_3 grid_4">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label" for="body"><?php echo $this->lang->line('') ?>Localidad</label>

                    <div class="col-sm-6">
                        <input type="text" placeholder="Nombre de localidad"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" value="templates/local_input" id="action-url">
                    </div>
                </div>
