        ...
        <div class="content-body">
            <section>
                <div class="row wrapper white-bg page-heading">
                    ...
                    <div class="col-md-8">
                        <div class="card card-block">
                            <h4><?php echo $this->lang->line('Apartment Details') ?></h4> 
                            <hr>
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('Landlord Name') ?></strong>
                                </div>
                                <div class="col-md-10">
                                    <?php echo $details['name'] ?>
                                    <?php echo $details['unoapellido'] ?>
                                </div>
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('Cell phone') ?></strong>
                                </div>
                                <div class="col-md-10">
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('Number of rooms') ?></strong>
                                </div>
                                <div class="col-md-10">
                                    <?php echo $details['cuartos'] ?>
                                </div>
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('Number of bathrooms') ?></strong>
                                </div>
                                <div class="col-md-10">
                                    <?php echo $details['banos'] ?>
                                </div>
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong>Air type</strong>
                                </div>
                                <div class="col-md-10">
                                    <?php echo $details['aire'] ?>
                                </div>
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('Flat') ?></strong>
                                </div>
                                <div class="col-md-10">
                                    <?php echo $details['pisos'] ?>
                                </div>
